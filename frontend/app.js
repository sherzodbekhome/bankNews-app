...
const I18N={
  uz:{
    sub:"Moliyaviy Bozor Ma'lumotlari",t0:"Valyuta Kurslari",t1:"Kriptovalyuta",t2:"Moliyaviy Kalkulyator",t3:"Qimmatbaho Metallar",
    nav_ai:"AI Bozor Tahlili",nav_settings:"Sozlamalar",nav_premium:"Premium",
    loading:"Ma'lumotlar yuklanmoqda...",cbu_rates:"Markaziy Bank Rasmiy Kurslari",bank_rates:"Tijorat Banklari Kurslari",
    crypto_usd:"Kriptovalyuta — USD",crypto_uzs:"So'mdagi Ekvivalent",metals_title:"Qimmatbaho Metallar Bozori",
    metals_uzs:"So'mdagi Ekvivalent",amount:"Summa",select_cur:"Valyutani tanlang",
    calc_btn:"Hisoblash",result:"Hisoblash Natijasi",err:"Internet aloqasini tekshiring va qayta urinib ko'ring",
    buy:"Sotib olish kursi",sell:"Sotish kursi",bank:"Bank",per_gram:"1 gramm",
    chart_title:"30 Kunlik Valyuta Kursi Dinamikasi",chart_empty:"Kurs tarixi ma'lumotlari shakllantirilmoqda...",
    sub_desc:"Har kuni 09:45 va 18:00 da Markaziy Bank va tijorat banklari kurslari yuboriladi.",
    soz_title:"Sozlamalar",soz_sub:"Interfeys tili, mavzu va bildirishnomalar",
    soz_premium:"Premium Tarifga O'tish",soz_premium_sub:"Cheksiz funksiyalar va sun'iy intellekt tahlili",
    soz_account:"Foydalanuvchi Hisobi",soz_lang_lbl:"Interfeys tili",soz_theme_sec:"Interfeys ko'rinishi",
    soz_theme:"Rang sxemasi",soz_notif:"Bildirishnomalar",
    soz_daily:"Kunlik kurs bildirishi",soz_alerts:"Narx chegarasi ogohlantirishlari",
    soz_about:"Ilova haqida ma'lumot",soz_channel:"Rasmiy axborot kanali",soz_version:"Versiya",
  },
  uz_cyr:{
    sub:"Молиявий Бозор Маълумотлари",t0:"Валюта Курслари",t1:"Криптовалюта",t2:"Молиявий Калкулятор",t3:"Қимматбаҳо Металлар",
    nav_ai:"AI Бозор Таҳлили",nav_settings:"Созламалар",nav_premium:"Премиум",
    loading:"Маълумотлар юкланмоқда...",cbu_rates:"Марказий Банк Расмий Курслари",bank_rates:"Тижорат Банклари Курслари",
    crypto_usd:"Криптовалюта — USD",crypto_uzs:"Сўмдаги Эквивалент",metals_title:"Қимматбаҳо Металлар Бозори",
    metals_uzs:"Сўмдаги Эквивалент",amount:"Сумма",select_cur:"Валютани танланг",
    calc_btn:"Ҳисоблаш",result:"Ҳисоблаш Натижаси",err:"Интернет алоқасини текшириб, қайта уриниб кўринг",
    buy:"Сотиб олиш курси",sell:"Сотиш курси",bank:"Банк",per_gram:"1 грамм",
    chart_title:"30 Кунлик Валюта Курси Динамикаси",chart_empty:"Курс тарихи маълумотлари шаклланмоқда...",
    sub_desc:"Ҳар куни 09:45 ва 18:00 да Марказий банк ва тижорат банклари курслари юборилади.",
    soz_title:"Созламалар",soz_sub:"Интерфейс тили, мавзу ва билдиришномалар",
    soz_premium:"Премиум Тарифга Ўтиш",soz_premium_sub:"Чексиз функциялар ва сунъий интеллект таҳлили",
    soz_account:"Фойдаланувчи Ҳисоби",soz_lang_lbl:"Интерфейс тили",soz_theme_sec:"Интерфейс кўриниши",
    soz_theme:"Ранг схемаси",soz_notif:"Билдиришномалар",
    soz_daily:"Кунлик курс билдириши",soz_alerts:"Нарх чегараси огоҳлантиришлари",
    soz_about:"Илова ҳақида маълумот",soz_channel:"Расмий ахборот канали",soz_version:"Версия",
  },
  qqp:{
    sub:"Maliyelik Bazar Maǵlıwmatları",t0:"Valyuta Kursleri",t1:"Kriptovalyuta",t2:"Maliyelik Kalkulyator",t3:"Qımbat Metallar",
    nav_ai:"AI Bazar Analizi",nav_settings:"Sazlamalar",nav_premium:"Premium",
    loading:"Maǵlıwmatlar júkleniwde...",cbu_rates:"Oraylıq Bank Resmiy Kursleri",bank_rates:"Tiykarlı Banklar Kursleri",
    crypto_usd:"Kriptovalyuta — USD",crypto_uzs:"Sómdegi Ekvivalent",metals_title:"Qımbat Metallar Bazarı",
    metals_uzs:"Sómdegi Ekvivalent",amount:"Summa",select_cur:"Valyutanı tańlań",
    calc_btn:"Esaplań",result:"Esaplaw Nátiyjesi",err:"Internet baylanısın tekserip, qayta urınıp kóriń",
    buy:"Satıp alıw kursi",sell:"Satıw kursi",bank:"Bank",per_gram:"1 gramm",
    chart_title:"30 Kúnlik Valyuta Kursi Dinamikası",chart_empty:"Kurs tariyxı maǵlıwmatları jiynalıwda...",
    sub_desc:"Hár kúni 09:45 hám 18:00 de Oraylıq bank hám tiykarlı banklar kursleri jiberiledi.",
    soz_title:"Sazlamalar",soz_sub:"Interfeys tili, tema hám xabarlamalar",
    soz_premium:"Premium Tarifke Ótiw",soz_premium_sub:"Sheksiz funkciyalar hám sun'iy intellekt analizi",
    soz_account:"Paydalanıwshı Есabı",soz_lang_lbl:"Interfeys tili",soz_theme_sec:"Interfeys kórinisi",
    soz_theme:"Reń sxemasi",soz_notif:"Xabarlamalar",
    soz_daily:"Kúnlik kurs xabarı",soz_alerts:"Baǵa shegara eskertpeleri",
    soz_about:"Ilova haqqında maǵlıwmat",soz_channel:"Resmiy axborat kanali",soz_version:"Versiya",
  },
  ru:{
    sub:"Финансовые Рыночные Данные",t0:"Валютные Курсы",t1:"Криптовалюта",t2:"Финансовый Калькулятор",t3:"Драгоценные Металлы",
    nav_ai:"AI Анализ Рынка",nav_settings:"Настройки",nav_premium:"Премиум",
    loading:"Загрузка данных...",cbu_rates:"Официальные Курсы ЦБ",bank_rates:"Курсы Коммерческих Банков",
    crypto_usd:"Криптовалюта — USD",crypto_uzs:"Эквивалент в Сумах",metals_title:"Рынок Драгоценных Металлов",
    metals_uzs:"Эквивалент в Сумах",amount:"Сумма",select_cur:"Выберите валюту",
    calc_btn:"Рассчитать",result:"Результат расчёта",err:"Проверьте интернет-соединение и повторите попытку",
    buy:"Курс покупки",sell:"Курс продажи",bank:"Банк",per_gram:"1 грамм",
    chart_title:"Динамика курса за 30 дней",chart_empty:"Исторические данные накапливаются...",
    sub_desc:"Ежедневно в 09:45 и 18:00 публикуются курсы ЦБ и коммерческих банков.",
    soz_title:"Настройки",soz_sub:"Язык интерфейса, тема и уведомления",
    soz_premium:"Перейти на Premium тариф",soz_premium_sub:"Безлимитный доступ и анализ ИИ",
    soz_account:"Учётная запись",soz_lang_lbl:"Язык интерфейса",soz_theme_sec:"Оформление интерфейса",
    soz_theme:"Цветовая схема",soz_notif:"Уведомления",
    soz_daily:"Ежедневная рассылка курсов",soz_alerts:"Уведомления о ценовых порогах",
    soz_about:"О приложении",soz_channel:"Официальный информационный канал",soz_version:"Версия",
  },
  en:{
    sub:"Financial Market Intelligence",t0:"Exchange Rates",t1:"Cryptocurrency",t2:"Financial Calculator",t3:"Precious Metals",
    nav_ai:"AI Market Analysis",nav_settings:"Settings",nav_premium:"Premium",
    loading:"Loading data...",cbu_rates:"Central Bank Official Rates",bank_rates:"Commercial Bank Rates",
    crypto_usd:"Cryptocurrency — USD",crypto_uzs:"UZS Equivalent",metals_title:"Precious Metals Market",
    metals_uzs:"UZS Equivalent",amount:"Amount",select_cur:"Select currency",
    calc_btn:"Calculate",result:"Calculation Result",err:"Check your internet connection and try again",
    buy:"Buy rate",sell:"Sell rate",bank:"Bank",per_gram:"1 gram",
    chart_title:"30-Day Exchange Rate Dynamics",chart_empty:"Historical rate data is being accumulated...",
    sub_desc:"Central Bank and commercial bank rates are published daily at 09:45 and 18:00.",
    soz_title:"Settings",soz_sub:"Interface language, theme and notifications",
    soz_premium:"Upgrade to Premium",soz_premium_sub:"Unlimited access & AI analysis",
    soz_account:"User Account",soz_lang_lbl:"Interface Language",soz_theme_sec:"Interface Theme",
    soz_theme:"Color Scheme",soz_notif:"Notifications",
    soz_daily:"Daily rate newsletter",soz_alerts:"Price threshold alerts",
    soz_about:"About the app",soz_channel:"Official information channel",soz_version:"Version",
  },
};
...
const CALC_MODE_LABELS={valyuta:'Valyuta konvertatsiyasi',kredit:'Kredit kalkulyatori',depozit:'Depozit kalkulyatori',maosh:'Mehnat haqi kalkulyatori',bankcomp:'Bank kurslari taqqoslamasi',maqsad:'Moliyaviy maqsad rejalashtiruvchi',foyda:'Investitsiya P&L tahlili',stavkadep:'Depozit stavkalari taqqoslamasi',stavkakred:'Kredit stavkalari taqqoslamasi'};
...
function doProfit(){
  ...
  document.getElementById('plPnlLbl').textContent=up?'Sof foyda':'Sof zarar';
